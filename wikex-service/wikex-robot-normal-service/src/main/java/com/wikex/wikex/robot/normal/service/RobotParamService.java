...
public class RobotParamService {
	...
	public void update(String coinName, RobotParams params){
        ...
        if(param != null){
            ...
            update.set("maxRandomPrice", params.getMaxRandomPrice());
            update.set("absolutePriceStep", params.getAbsolutePriceStep());
            ...
            robotParams.setMaxRandomPrice(params.getMaxRandomPrice());
            robotParams.setAbsolutePriceStep(params.getAbsolutePriceStep());

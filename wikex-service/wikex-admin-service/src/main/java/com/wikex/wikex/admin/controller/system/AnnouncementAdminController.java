...
public class AnnouncementAdminController extends BaseController {
    ...
    @PostMapping("top")
    @AccessLog(module = AdminModule.CMS, operation = "Pin announcement to top")
    ...
    /**
     * Cancel announcement top
     * @param id
     * @return
     */
    @RequiresPermissions("system:announcement:dwon")
    @PostMapping("down")
    @AccessLog(module = AdminModule.CMS, operation = "Unpin announcement from top")

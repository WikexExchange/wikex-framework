...
import com.wikex.wikex.util.DESUtil;
...
public class TransferController extends BaseController {
    ...
    @ApiOperation(value = "Query transfer address information by coin")
    @ApiImplicitParams({
    ...
    @ApiOperation(value = "Transfer application")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "unit", value = "Coin unit"),
    ...
    @ApiOperation(value = "Transfer records")
    @PermissionOperation

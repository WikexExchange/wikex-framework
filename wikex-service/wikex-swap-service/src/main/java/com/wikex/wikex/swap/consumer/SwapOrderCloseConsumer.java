...
@Slf4j
@Component
@RocketMQMessageListener(topic = "swap-order-close", consumerGroup = "swap-swap-order-close")
public class SwapOrderCloseConsumer implements RocketMQListener<String> {

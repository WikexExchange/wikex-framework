...
public class ExchangePushJob {
    ...
    public void pushTickKline(String symbol, List<KLine> klineList){
        messagingTemplate.convertAndSend("/topic/swap/kline/"+symbol, klineList);
        for (KLine kLine : klineList) {
            nettyHandler.handleKLine(symbol, kLine);
        }
    }

    public void pushTickTrade(String symbol, List<ContractTrade> trades){

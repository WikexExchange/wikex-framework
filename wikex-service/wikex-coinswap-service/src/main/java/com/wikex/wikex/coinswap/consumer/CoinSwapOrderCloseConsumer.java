...
@Slf4j
@Component
@RocketMQMessageListener(topic = "swap-coin-order-close", consumerGroup = "coinswap-swap-coin-order-close")
public class CoinSwapOrderCloseConsumer implements RocketMQListener<String> {

...
@Slf4j
@Component
@RocketMQMessageListener(topic = "swap-coin-order-cancel", consumerGroup = "coinswap-swap-coin-order-cancel")
public class CoinSwapOrderCancelConsumer implements RocketMQListener<String> {

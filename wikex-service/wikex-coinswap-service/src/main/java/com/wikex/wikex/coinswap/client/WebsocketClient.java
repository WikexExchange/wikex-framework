package com.wikex.wikex.coinswap.client;
...
/**
 *  Huobi WebSocket K-line data acquisition
 *  Documentation: https://huobiapi.github.io/docs/spot/v1/cn/#k-2
 */
        ...
        try {
            client = new WebSocketClient(new URI("wss://api.huobi.pro/ws"),new Draft_6455()) {
                ...
                public void onMessage(ByteBuffer bytes) {
                    try {
                        String message = new String(ZipUtil.unGzipData(bytes.array()), "UTF-8");/* Decompress GZIP */
                        ...
                        if(null != jsonObject.getString("ping")){/* Check if it's a Ping */
                            System.out.println("Received message: " + message);/* Received Ping message */
                            JSONObject json = new JSONObject();
                            json.put("pong", getSeconds());
...
/* Zip utility class */
class ZipUtil {
    public static byte[] unGzipData(byte[] depressData) throws Exception {

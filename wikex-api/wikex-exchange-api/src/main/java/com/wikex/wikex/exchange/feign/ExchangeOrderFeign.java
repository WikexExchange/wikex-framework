 ...
 * @Description:
 ****/
@FeignClient(value = "wikex-exchange",contextId = "exchangeOrderFeign")
public interface ExchangeOrderFeign {
    ...
    @PostMapping(value = "/orderFeign/findByOrderIds")
    List<ExchangeOrder> findByOrderIds(@RequestBody List<String> orderIds);

    @PostMapping(value = "/orderFeign/forceCancelOrder")
    MessageResult forceCancelOrder(@RequestBody ExchangeOrder order);

    /**
     * Market-making bot special: current orders
     * @param uid
     * @param sign
     * @return
     */
     ...
     * @return
     */
    @RequestMapping("/orderFeign/mockovertimeydhdnskd")
    Page<ExchangeOrder> currentOrderMockOvertime(
            @RequestParam("uid") Long uid,
            @RequestParam("sign") String sign,
            @RequestParam("symbol") String symbol,
            @RequestParam("pageNo") int pageNo,
    ...
    /**
     * Market-making bot special: cancel order
     * @param uid
     * @param orderId
     * @return
     */
    ...
    /**
     * Market-making bot special: add order
     * @param uid
     * @param sign
     * @param direction
     * @param symbol

...
public enum MainCoinType {
    ...
    MainCoinType(String code, String symbol){
        this.code=code;
        this.symbol=symbol;
    }

    public static MainCoinType symbolOf(String symbol) {
        switch (symbol){
    ...
    public static MainCoinType codeOf(int code){
        switch (code){

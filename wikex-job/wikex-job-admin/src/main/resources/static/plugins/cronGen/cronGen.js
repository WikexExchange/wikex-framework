(function ($) {
    ...
    $.fn.extend({
        cronGen: function (options) {
            ...
            $(seconds1).append("Every second, allowed wildcards [, - * /]");
            ...
            $(minutes1).append("Every minute, allowed wildcards [, - * /]");
            ...
            $(hourly1).append("Every hour, allowed wildcards [, - * /]");
            ...
            $(weekly4).append("week of the week day");
...
(function ($) {
    ...
    $.fn.cronGen.tools = {
        ...
        cronParse: function (cronExpress) {
            // Get the values of the expression in the parameter
            if (cronExpress) {

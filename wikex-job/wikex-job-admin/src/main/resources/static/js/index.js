...
$(function () {
    ...
    $('#filterTime').daterangepicker({
        ...
        showDropdowns:false,        // Whether to display year/month selection
        timePicker: true, 			// Whether to display hour and minute selection
        timePickerIncrement: 10, 	// Time increment, unit: minutes
        timePicker24Hour : true,
        opens : 'left', // Popup position of the date selection box
        ranges: rangesConf,
        locale : {
            ...
            daysOfWeek : I18n.daterangepicker_custom_daysofweek.split(','),        // 'Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'
            monthNames : I18n.daterangepicker_custom_monthnames.split(','),        // 'Jan', 'Feb', ... 'Dec'
            firstDay : 1
        },

...
<div class="wrapper">
	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			...
			<!--
			<h1>Operation Report<small>Task Scheduling Center</small></h1>
			<ol class="breadcrumb">
				<li><a><i class="fa fa-dashboard"></i>Scheduling Center</a></li>
		...
		<section class="content">
                    ...
                    <div class="info-box bg-yellow">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="progress-description">
                                ...
                                <#--<#if jobLogCount gt 0>
                                    Scheduling success rate: ${ (jobLogSuccessCount*100/jobLogCount)?string("0.00") }<small>%</small>
                                </#if>-->
                            </span>
                        </div>
                    </div>
            ...
            <#-- Scheduling Report: Time range filter, left line chart + right pie chart -->
            <div class="row">
                <div class="col-md-12">
                    <div class="box">

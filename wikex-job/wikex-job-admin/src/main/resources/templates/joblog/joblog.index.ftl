	...
	<div class="content-wrapper">
	    ...
	    <section class="content">
 					...
 					<div class="input-group">
                		...
                		<select class="form-control" id="jobGroup"  paramVal="<#if jobInfo?exists>${jobInfo.jobGroup}</#if>" >
                            <#if Request["XXL_JOB_LOGIN_IDENTITY"].role == 1>
                                <option value="0" >${I18n.system_all}</option>  <#-- Only administrators can query all; normal users can only query authorized jobGroups -->
                            </#if>
			...
			<div class="row">
				<div class="col-xs-12">
					<div class="box">
			            <#--<div class="box-header hide"><h3 class="box-title">Scheduling Logs</h3></div>-->
			            <div class="box-body">
			              	<table id="joblog_list" class="table table-bordered table-striped display" width="100%" >
				                <thead>
					            	<tr>
										...
										<#--<th name="executorAddress" >Executor Address</th>
										<th name="glueType" >Run Mode</th>
                                      	<th name="executorParam" >Task Parameters</th>-->

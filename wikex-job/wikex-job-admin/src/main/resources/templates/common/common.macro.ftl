	...
	<aside class="control-sidebar control-sidebar-dark">
		...
		<div class="tab-content">
				...
				<ul class="control-sidebar-menu">
					<li>
						<a href="javascript::;">
							...
							<div class="menu-info">
								<h4 class="control-sidebar-subheading">Wikex Birthday Today</h4>
								<p>2015-09-10</p>
							</div>
						</a>
					</li>
					<li>
						<a href="javascript::;"> 
							...
							<div class="menu-info">
								<h4 class="control-sidebar-subheading">Frodo Updated Profile</h4>
								<p>Updated phone number +1(800)555-1234</p>
							</div>
						</a>
					</li>
					<li>
					...
					<li>
						...
						<div class="menu-info">
							<h4 class="control-sidebar-subheading">Scheduled Job #001</h4>
							<p>Executed 5 seconds ago</p>
						</div>
						</a>
					</li>
				</ul>
			...
			<div class="tab-pane" id="control-sidebar-settings-tab">
				<form method="post">
					<h3 class="control-sidebar-heading">Personal Settings</h3>
					<div class="form-group">
						<label class="control-sidebar-subheading"> Left Sidebar Auto-Adjust
							<input type="checkbox" class="pull-right" checked>
						</label>
						<p>Left sidebar style auto-adjustment</p>
					</div>
					<!-- /.form-group -->
	...
	<footer class="main-footer">
		...
		<div class="pull-right hidden-xs">
            <strong>Copyright &copy; 2015-${.now?string('yyyy')} &nbsp;
                <a href="https://www.william.com/" target="_blank" >william</a>
				&nbsp;
                <a href="https://github.com/william/xxl-job" target="_blank" >github</a>

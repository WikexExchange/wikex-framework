			...
			<div class="modal-header">
         	...
         	<div class="modal-body">
				<form class="form-horizontal form" role="form" >
                    ...
                    <p style="margin: 0 0 10px;text-align: left;border-bottom: 1px solid #e5e5e5;color: gray;">${I18n.jobinfo_conf_base}</p>   <#-- Basic Information -->
                    ...
                    <br>
                    <p style="margin: 0 0 10px;text-align: left;border-bottom: 1px solid #e5e5e5;color: gray;">${I18n.jobinfo_conf_schedule}</p>    <#-- Schedule -->
                    <div class="form-group">
                    ...
                    <br>
                    <p style="margin: 0 0 10px;text-align: left;border-bottom: 1px solid #e5e5e5;color: gray;">${I18n.jobinfo_conf_job}</p>   <#-- Task Configuration -->
                    ...
                    <br>
                    <p style="margin: 0 0 10px;text-align: left;border-bottom: 1px solid #e5e5e5;color: gray;">${I18n.jobinfo_conf_advanced}</p>    <#-- Advanced Configuration -->
...
<input type="hidden" name="glueRemark" value="GLUE Code Initialization" >
...
logging.info("Script file: " + sys.argv[0])
-->
</textarea>
<#-- There is an issue: after creating a task with run mode set to PHP, the GLUE section does not contain the following PHP code -->
...
<#--for (var i = 2; i < arguments.length; i++){
	console.log("Parameter %s = %s", (i-1), arguments[i]);
}-->
			...
			<div class="modal-header">
         	...
         	<div class="modal-body">
				<form class="form-horizontal form" role="form" >
                    ...
                    <br>
                    <p style="margin: 0 0 10px;text-align: left;border-bottom: 1px solid #e5e5e5;color: gray;">${I18n.jobinfo_conf_schedule}</p>    <#-- Scheduling Configuration -->
                    ...
                    <br>
                    <p style="margin: 0 0 10px;text-align: left;border-bottom: 1px solid #e5e5e5;color: gray;">${I18n.jobinfo_conf_job}</p>    <#-- Job Configuration -->
